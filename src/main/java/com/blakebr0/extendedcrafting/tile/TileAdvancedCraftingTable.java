...
public class TileAdvancedCraftingTable extends TileEntity implements IInventory, IExtendedTable {
	...
	private final NonNullList<ItemStack> matrix = NonNullList.withSize(25, ItemStack.EMPTY);
	private final InventoryCraftingRef inventoryCraftingRef = new InventoryCraftingRef(matrix, 5, 5);
