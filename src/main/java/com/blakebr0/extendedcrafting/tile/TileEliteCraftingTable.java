...
public class TileEliteCraftingTable extends TileEntity implements IInventory, IExtendedTable {
	...
	private final NonNullList<ItemStack> matrix = NonNullList.withSize(49, ItemStack.EMPTY);
	private final InventoryCraftingRef inventoryCraftingRef = new InventoryCraftingRef(matrix, 7, 7);
